...
export class PropertyClass extends PrefixSuffixClass implements Property {
  ...
  /**
   * Binded properties names list.
  private _binded: Array<string> = [];
  set binded(property: Array<string> | number | string) {
  ...
  get binded(): Array<string> | number | string {
    return this._binded;
  }
   */

  /**
   * Wrapped properties names list.
   */
  ...
  */
  ...
  unbind<S>(source: S, properties?: string | Array<string>): this {
    try {
      this
        .toArray(properties)
        .forEach((property: string) => this._unbind(source, property));
    } catch (e) {
      if (e instanceof TypeError) {
      } else if (e instanceof RangeError) {
      } else if (e instanceof EvalError) {
  ...
  unwrap<S>(source: S, properties?: string | Array<string>): this {
    try {
      this
        .toArray(properties)
        .forEach((property: string) => this._unwrap(source, property));
    } catch (e) {
      if (e instanceof TypeError) {
      } else if (e instanceof RangeError) {
      } else if (e instanceof EvalError) {
  ...
  wrap<S, R = any>(source: Function | S, properties: string | Array<string>, setter?: Setter<S, R>, getter?: Getter<S, R>): this {
    try {
      this
        .toArray(properties)
        .forEach((property: string) => this._wrap(source, property, setter, getter));
    } catch (e) {
      if (e instanceof TypeError) {
      } else if (e instanceof RangeError) {
      } else if (e instanceof EvalError) {
   ...
   */
  private define<S>(source: Function | S, property: string, descriptor: PropertyDescriptor, type?: 'bind' | 'wrap'): this {
    if (!descriptor.get) {
  ...
  private _wrap<S, R = any>(source: Function | S, property: string, setterCallback?: Setter<S, R>, getterCallback?: Getter<S, R>): void {
    ...
    if (sourcePropertyName) {
      ...
      const set = function setter(this: S, value: R | undefined): void {
        // console.log(`seeeeeeeeeet`, value);
      ...
      this.define(source, sourcePropertyName, {
        ...
        .define(source, property, { get, set }, 'wrap');
