...
testing
  .spec('', {
    ...
    'component property `removed` should be equal `true`': () => testing
      .equal<boolean>('removed', true)
      .equal<boolean>({ removed: true })
      .equal<boolean>(['removed'], true)
      .truthy('removed'),

    'component property `removed` should be `true`': () => testing
    ...
    'subscribe to component property `observable$` ': () => testing
      .before(component => {
    ...
    '`before()` method returned value number should `be()` the same': () => testing
      .before(() => 27)
      .be<number>(27)
     ...
     * Actual Or Expected.
     */
    '`before()` method returned value string should `be()` the same': () => testing
      .before(() => {
        const x = 27;
    ...
    // boolean.
    '`be()` method with passed `actualOrExpected` json where expected value type is boolean': () => testing
    ...
    // boolean
    '`be()` method with passed json with many keys where expected type is boolean ': () => testing
      .be<boolean>({
    ...
    // Number.
    '`be()` method with passed `actualOrExpected` json where expected value type is number': () => testing
    ...
    // String.
    '`be()` method with passed `actualOrExpected` json where expected value type is string': () => testing
    ...
    // any.
    '`be()` method with passed json with many keys where expected type is any': () => testing
      .be<any>({
        active: false,
        firstname: 'Eve',
        age: 127
     ...
     */
    // Boolean.
    '`be()` method with passed actual and type boolean expected argument': () => testing
    ...
    // Number.
    '`be()` method with passed actual and type number expected argument': () => testing
    ...
    // String.
    '`be()` method with passed actual and type string expected argument': () => testing
      .be<string>('firstname', 'Eve')     // Checking component to have property `firstname` value 'Eve'.
      .not
      .be<string>('surname', 'Eveline'),  // Checking component to NOT have property `surname` value 'Eveline'.

    '`be()` method with passed list of component property names and their expected value type `string`': () => testing
      .be<string>([
  ...
  .spec('', {
     ...
     */
    // boolean.
    '`equal()` method with passed `actualOrExpected` json where expected value type is boolean': () => testing
    ...
    // boolean
    '`equal()` method with passed json with many keys where expected type is boolean ': () => testing
      .equal<boolean>({
        active: false,  // Checking component to have property `active` `false`.
        removed: true   // Checking component to have property `removed` `true`.
      }),
    ...
    // Number.
    '`equal()` method with passed `actualOrExpected` json where expected value type is number': () => testing
    ...
    // String.
    '`equal()` method with passed `actualOrExpected` json where expected value type is string': () => testing
    ...
    // any.
    '`equal()` method with passed json with many keys where expected type is any': () => testing
      .equal<any>({
        active: false,
        firstname: 'Eve',
        age: 127
     ...
     */
    // Boolean.
    '`equal()` method with passed actual and type boolean expected argument': () => testing
    ...
    // Number.
    '`equal()` method with passed actual and type number expected argument': () => testing
    ...
    // String.
    '`equal()` method with passed actual and type string expected argument': () => testing
      .equal<string>('firstname', 'Eve')   // Checking component to have property `firstname` value 'Eve'.
      .not
      .equal<string>('surname', 'Eveline'), // Checking component to NOT have property `surname` value 'Eveline'.

    '`equal()` method with passed list of component property names and their expected value type `string`': () => testing
      .equal<string>([
        'firstname',  // Component property firstname to test against expected `Eve`.
        'surname'     // Component property surname to test against expected `Eve`.
      ], 'Eve'),      // Expected value.
    ...
    // Object.
    '`equal()` method with passed component property name and expected value type `Object`': () => testing
  ...
  .spec('', {
    ...
    'should have div with attribute data-src with specified value': () => testing
      ...
      .clear(),
    // Find attribute `data-src` with specified value and expect it exists.
    'should have div with attribute data-src without specyfing value': () => testing
      .attribute('data-src')
      .contain('Attribute')
      .not
      .contain('Attribute1')
    ...
    'should have class': () => testing.class('getclass')
  })
  .execute();
// End Step 3.
