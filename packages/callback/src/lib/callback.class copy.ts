...
export class Callback<AllowNames extends string> {
  /**
   * A private instance of `ValidationError` for static `Callback`.
   */
  static #defaultValidationError = new ValidationError();

  /**
   * An instance of `ValidationError` for static `Callback`.
   */
  static set validationError(validationError: ValidationError) {
    guardInstance(validationError, ValidationError) &&
      (this.#defaultValidationError = validationError);
  }
  static get validationError(): ValidationError {
  ...
  /**
   * A private instance of `ValidationError` for instance methods.
   */
  #validationError = Callback.#defaultValidationError;
  //#endregion
  ...
  constructor(...allowNames: AllowNames[]) {
    guardArray(allowNames) && (this.#allowedNames = new Set(allowNames));
  }
